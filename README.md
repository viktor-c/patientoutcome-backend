...
* the waiter takes the order and communicates it to the kitchen (**services** and **repositories**).
* Then, they bring back the prepared food (**response to the customer**).
