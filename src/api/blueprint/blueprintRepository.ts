  ...
  private _mockBlueprints: Partial<Blueprint>[] = [
    {
      ...
      content: {
        ...
        consultations: ["68c08903290365a33d085fce", "68c08903290365a33d085fcb", "68c08903290365a33d085fcf"],
      },
      tags: ["case", "patient-care", "orthopedics", "template"],
    },
    // MICA template for pre surgery consultation
    {
      ...
      title: "MICA pre surgery",
      description: "Template for pre surgery consultation",
      timeDelta: "0",
      content: {
        patientCaseId: "", // id of the parent patient case
        dateAndTime: "0", //Date object for consultation scheduling
        ...
        formTemplates: [
          ...
          "67b4e612d0feb4ad99ae2e8b",
        ],
      },
      tags: ["consultation", "clinical", "documentation", "patient-care"],
    },
    // MICA template for 6 week post surgery consultation
    {
